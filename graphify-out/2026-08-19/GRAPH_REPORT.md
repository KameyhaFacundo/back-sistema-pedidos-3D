...
## Summary
- 466 nodes · 902 edges · 46 communities (39 shown, 7 thin omitted)
...
Cohesion: 0.07
Nodes (29): App\Http\Controllers\Api\AuthController, AuthController, App\Http\Controllers\Api\CocinaController, CocinaController, App\Http\Controllers\Api\CuponController, App\Http\Controllers\Api\EmpresaController, EmpresaController, App\Http\Controllers\Api\MenuController (+21 more)
...
### Community 2 - "Pedido"
Cohesion: 0.07
Nodes (13): App\Http\Controllers\Api\MetricaController, MetricaController, App\Http\Controllers\Api\PedidoController, PedidoController, ArVista, Llamado, Pedido, PedidoItem (+5 more)
...
### Community 5 - "Plato"
Cohesion: 0.11
Nodes (11): App\Http\Controllers\Api\PlatoController, PlatoController, Plato, Database\Factories\UserFactory, UserFactory, Illuminate\Database\Eloquent\Factories\Factory, Illuminate\Support\Facades\Storage, Illuminate\Support\Str (+3 more)
...
Cohesion: 0.06
Nodes (19): Empresa, App\Models\User, User, Illuminate\Database\Eloquent\Factories\HasFactory, Illuminate\Foundation\Auth\User, Illuminate\Foundation\Testing\RefreshDatabase, Illuminate\Foundation\Testing\TestCase, Illuminate\Notifications\Notifiable (+11 more)
...
- **Why does `Empresa` connect `Empresa` to `Illuminate\Http\Request`, `Pedido`, `Illuminate\Database\Seeder`, `Plato`, `Cupon`, `RoleTest`, `PedidoTest`?**
  _High betweenness centrality (0.199) - this node is a cross-community bridge._
- **Why does `User` connect `Empresa` to `Illuminate\Http\Request`, `Pedido`, `Illuminate\Database\Seeder`, `Plato`, `Cupon`, `RoleTest`, `PedidoTest`?**
